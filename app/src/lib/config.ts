...
//
// Re-exported from the canonical usdc.ts module.  All app code should import
// from "@/lib/usdc" (or here — both work) rather than re-implementing money
// math inline.  The parity test at src/__tests__/usdc-parity.test.ts ensures
// these helpers stay behaviourally identical to sdk/src/utils.ts.
//
// See app/src/lib/usdc.ts for full documentation and invariants.
