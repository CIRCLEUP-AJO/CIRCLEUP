...
// ─── Test addresses ───────────────────────────────────────────────────────────
// All addresses below are valid Stellar strkeys with correct checksums.
// G-addresses are from Keypair.random(); C-addresses are StrKey.encodeContract
// of known byte arrays.  None of these keys hold real funds.

const CREATOR_ADDR    = "GAT7ENDOFKLS73UI2OQMEHLUFOGEM3SMMENL2RFDOZSLKGRGZNBGB4MJ";
const MEMBER_A_ADDR   = "GAWSJKEV5PALBVQGN5VQE24LNM5K3OD67XA7BRLQKN53LAOI2YBET4HV";
const MEMBER_B_ADDR   = "GDPJGJMNKKN6Q6MBG52S3N3HDNNW5DCRZVHPCOJ44MJNIUGUSP4HZUZX";
const CIRCLE_ADDR     = "CAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABSC4";
const REPUTATION_ADDR = "CAAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQC526";
